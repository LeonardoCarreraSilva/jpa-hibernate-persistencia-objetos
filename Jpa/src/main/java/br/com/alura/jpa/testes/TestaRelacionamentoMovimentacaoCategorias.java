...
public class TestaRelacionamentoMovimentacaoCategorias {
	public static void main(String[] args) {
		
		Categoria categoria = new Categoria("Viagem");
		Categoria categoria2 = new Categoria("Viagem de negociiios");
		...
		movimentacao2.setDescricao("Volta de São Paulo");
